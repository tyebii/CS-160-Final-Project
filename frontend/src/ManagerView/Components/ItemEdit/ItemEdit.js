...
import ErrorBoundary from "../../../Components/ErrorBoundary"; // for testing
import carrot from "../../../Components/Welcome/Images/carrot.png"; // default img

// TO-DO: include upload img functionality
const ItemEdit = () => {
    ...
    const handleSubmit = async (e) => {
      e.preventDefault();
      try {
        await axios.put(`http://localhost:3301/updateItem/${itemid}`, formData);
